...
###  On the sidebar on the left-hand side of Andromeda click "Split"

![Split link on the sidebar](../assets/split-SB.png.png)

### Click on "Split". This will open a context menu where you can fill in the following values for your sub-server;
...
![Split context menu](../assets/split-CM.png)
</Steps>
...
![Split Server Row](../assets/split-ROW.png)

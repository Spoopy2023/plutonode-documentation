...
![Subdomain Delete BTN](../assets/rev-del.png)

This will open a context menu prompting you to confirm the reverse proxy deletion.<br/> You are required to confirm deletion of reverse proxies to prevent accidental deletion.

![Subdomain Delete CM](../assets/rev-delcm.png)

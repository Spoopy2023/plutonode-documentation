...
**1.** On the sidebar on the left-hand side of Andromeda click "Versions"

![Split link on the sidebar](../img/versions-SB.png)

**2.** Locate the Server Software you would like to run, in the table below select a Jar Version. <br/>

![Split context menu](../img/versions-lm.png)
*More server versions are avaliable, this image was taken on a pre-production build of Andromeda*

Leave the `"Keep Files"` button un-toggle if you are just replacing the server software but are maintaining the same server version. ![Keep Server Files](../img/versions-KF.png) <br/> However, if you are changing server version click the  `"Keep Files"`, it will become red and will read `"Delete Files"` ![Delete Server Files](../img/versions-DF.png)

**3.** Click the `"install"` button, this will open a context menu.  <br/> 

**This will be your last chance to cancel a version change** <br/>

![Version Changer Context Menu](../img/versions-cm.png)
